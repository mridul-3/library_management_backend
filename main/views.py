...
def get_books(request):
    try: 
        ...
        return JsonResponse({"status": 500, "message": "No Books Found!!!"})
@csrf_exempt
def create_book(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "Book not Added!!!"})
...
def delete_book(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "Book not Deleted!!!"})
...
def update_book(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "Book not Updated!!!"})
...
def book_by_id(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "Book not Found!!!"})
...
def create_user(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "User not created!!!"})
...
def get_all_users(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "User not found!!!"})
...
def user_details(request):
    try:
        ...
        return JsonResponse({"status": 400, "message": str(ve)})
    except Exception as e:
        return JsonResponse({"status":500, "message": "User not found!!!"})
...
def update_user(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "User not updated!!!"})
...
def delete_user(request):
    try:
        ...
        return JsonResponse({"status":500, "message": "User not deleted!!!"})
